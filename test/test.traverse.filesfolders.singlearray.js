...
describe('test.traverse.filesfolders.singlearrray.js::traverse:fssys:traverse-cli: Test Suite for Traverse Files and Folders returning single level array', function() {

    describe ('test.traverse.filesfolders.singlearrray.js::traverse:fssys:traverse-cli: [Test A] Test Suite for traversing folders in main repo directory', function() {
    ...
    describe ('test.traverse.filesfolders.singlearrray.js::traverse:fssys:traverse-cli: [Test B] Test Suite for traversing and searching folders in main repo directory', function() {
    ...
    describe ('test.traverse.filesfolders.singlearrray.js::traverse:fssys:traverse-cli: [Test C] Test Suite Recursive for traversing folders in subfolders of repo directory', function() {
    ...
    describe ('test.traverse.filesfolders.singlearrray.js::traverse:fssys:traverse-cli: [Test D] Test Suite Recursive for traversing and searching folders in main repo directory', function() {
    ...
    describe ('test.traverse.filesfolders.singlearrray.js::traverse:fssys:traverse-cli: [Test E] Test Suite Negatives for traversing folders in main repo directory', function() {
    ...
    describe ('test.traverse.filesfolders.singlearrray.js::traverse:fssys:traverse-cli: [Test F] Test Suite Negatives for traversing and searching folders in main repo directory', function() {
