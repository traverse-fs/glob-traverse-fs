...
//  * npmjs Link: 
//  * File: test/test.search.filesfolders.js
...
// describe('test.search.filesfolders.js::traverse:fssys:traverse-cli: Test Suite for Traverse Files and Folders', function() {
...
//     describe ('test.search.filesfolders.js::traverse:fssys:traverse-cli: [Test A] Test Suite for traversing and searching folders in main repo directory', function() {
...
//     describe ('test.search.filesfolders.js::traverse:fssys:traverse-cli: [Test B] Test Suite Recursive for traversing and searching folders in main repo directory', function() {
...
//     describe ('test.search.filesfolders.js::traverse:fssys:traverse-cli: [Test C] Test Suite Negatives for traversing and searching folders in main repo directory', function() {
